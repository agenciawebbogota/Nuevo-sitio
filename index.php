...
<html lang="es">
    <head>
        ...
        <meta property="og:description" content="Sitios Web Optimizados con Neuromarketing desde $79.000 + IVA por mes. Con Hosting, Dominio, Posicionamiento  y versión móviles" />
    ...
    <body class="index index-single parallax-title">
                ...
                <div class="row">
                    ...
                    <div class="span-6 more-info-meta">
                        ...
                        <ul class="bullet-list min-bp2">
                            ...
                            <li>Nuestros diseños te garantizan un retorno de tu inversión en poco tiempo</li>
        ...
        <section class="section banner alt">
            ...
            <section class="section secondary more-info" style="padding-bottom:10px">
            <div class="container">
                <div class="row">
                    <div class="span-6 more-info-meta">
                        <div class="section-title">
                            <h2 style="font-size:30px; text-align:center">¿Ya tienes un Sitio Web?</h2><br />
                            <h2 style="font-family: 'Lato', sans-serif; text-align:center"><i>Optimizalo con <br />Neuromarketing <br /> + <br/> Posicionamiento SEO</i></h2>
                        </div>
                        <br />
                        <h3 class="button-set" style="font-family: 'Lato', sans-serif; text-align:center">
                            <span class="text-div">
                            <a>Tu Sitio Web 300% mas efectivo</a></span>
                        </h3>
                    </div>
                    <div class="span-6 info-video" style="padding-top:40px; padding-bottom:10px">
                        <div class="auto-resizable-iframe">
                            <div>
                                <img itemprop="image" src="assets/images/multisitios_web.png" alt="Página web cargada en diferentes dispositivos" title="Diseño Web Optimizado">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row bp2 team-members">
                    ...
                    <div class="span-4 team-member">
                        <div class="team-pic">
                            <div class="mask"></div>
                            <img src="assets/images/julio.png" alt="" />
                        </div>

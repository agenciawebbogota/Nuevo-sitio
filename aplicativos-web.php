    ...
    <div class="container">
        <header class="sep active">
            <div class="section-title">
                <h3>Creamos aplicativos web que se puedan gestionar desde cualquier dispositivo, solo necesitas estar conectado internet ¡¡</h3>
            </div>
            <p>En Agencia Web Bogotá somos expertos en las atención y satisfacción del cliente.</p>
              <div class="section-title">
                  <h2>¿Por qué un <i>Aplicativos Web?</i></h2>
              </div>
        </header>
...
<section class="section banner2 alt">
    <div class="container">
        <div class="content">
            <h4>en <i>Agencia Web Bogotá</i> somos especialistas en<br/><b>Diseño y Desarrollo de Aplicativos Web</b></h4>
